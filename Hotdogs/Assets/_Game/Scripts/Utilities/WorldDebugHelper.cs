...
namespace HotDogs.HDUtils
{
    public class WorldDebugHelper : MonoSingleton<WorldDebugHelper>
    {
        /// <summary>
        /// fyi this class is dog shit but it only runs in debug so i can live with it
        /// </summary>
        ...
        {
#if !DEBUG
            // This code is so awful I don't want it to do anything outside of debug environments
            return;
#endif
        ...
        {
            // this is the reason this class can't have nice things
